    ...
    return ProblemTemplate(
        ...
        slots=(
            TextSlot(
                id="slot.q.text",
                prompt="",
                text="나누어 떨어지는 나눗셈식을 찾아 기호를 선택해 보세요.",
                style_role="question",
                x=56.986,
                y=46,
                font_size=28,
...
SEMANTIC_OVERRIDE = {
    ...
    "metadata": {
        "language": "ko",
        "question": "나누어떨어지는 나눗셈식을 찾아 기호를 선택해 보세요.",
        "instruction": "보기 중 나누어떨어지는 식의 기호를 고르세요.",
    },
    "domain": {
        "objects": [
            {
        ...
        "problem_solving": {
            "understand": {
                ...
                "condition_refs": ["rel.divisible"],
            },
            "plan": {
                "method": "compare_remainders",
                "description": "각 나눗셈식의 나머지를 확인해 나누어떨어지는 식을 고른다.",
            },
            "execute": {
                "expected_operations": [
                    "evaluate_division_expressions",
                    "check_for_remainder",
                    "select_divisible_choice",
                ]
            },
    ...
    "answer": {
        ...
        "choices": [],
        "answer_key": [],
        "target": {"type": "selected_choice", "description": "나누어떨어지는 나눗셈식의 기호"},
        "value": "㉡",
        "unit": "",
    },
}
