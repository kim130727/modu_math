    ...
    return ProblemTemplate(
        ...
        slots=(RectSlot(
            ...
            LineSlot(
                id="slot.table.v1",
                prompt="",
                x1 = 147.56, y1 = 130, x2 = 147.56, y2 = 220, stroke="#111827",
                stroke_width=1,
            ),
            LineSlot(
                id="slot.table.v2",
                prompt="",
                x1 = 267.56, y1 = 130, x2 = 267.56, y2 = 220, stroke="#111827",
                stroke_width=1,
            ),
            LineSlot(
                id="slot.table.v3",
                prompt="",
                x1 = 387.56, y1 = 130, x2 = 387.56, y2 = 220, stroke="#111827",
                stroke_width=1,
            ),
            LineSlot(
                id="slot.table.v4",
                prompt="",
                x1 = 507.56, y1 = 130, x2 = 507.56, y2 = 220, stroke="#111827",
                stroke_width=1,
            ),
            LineSlot(
                id="slot.table.h1",
                prompt="",
                x1 = 27.56, y1 = 175, x2 = 627.56, y2 = 175, stroke="#111827",
                stroke_width=1,
            ),
            TextSlot(
                id="slot.table.r1c1",
            ...
            TextSlot(
                ...
                prompt="",
                text="위인전",
                x = 206.412, y = 160.295, font_size=22,
                max_width=110,
                anchor="middle",
                style_role="table",
                fill="#111827",
