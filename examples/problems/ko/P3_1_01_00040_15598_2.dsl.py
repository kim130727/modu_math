...
PROBLEM_ID = "P3_1_01_00040_15598_2"
    ...
    return ProblemTemplate(
        ...
        regions=(
            ...
            Region(
                ...
                role="body",
                flow="absolute",
                slot_ids=(calculation_1_ids, 'konva_1786192274303_paste_279482_0'),
            ),
            Region(
        ...
        slots=(TextSlot(
            ...
            *_expanded_addition_slots(
            ...
            BlankSlot(
                ...
                answer_key="597",
                placeholder="수",
            ),RectSlot(id = 'konva_1786192274303_paste_279482_0', prompt = '', x = 330.931, y = 155.569, width = 20.242, height = 27, fill = '#ffffff', stroke = '#111111', stroke_width = 1, interaction = {'type': 'input', 'role': 'answer', 'value_type': 'digit', 'max_length': 1, 'include_in_submission': True, 'order': 0, 'group_id': 'final_answer', 'auto_advance': True, 'keyboard': 'number'}, input_style = {'font_size_mode': 'auto', 'font_size_adjust': 0, 'min_font_size': 14, 'max_font_size': 52, 'font_weight': 700, 'horizontal_align': 'center', 'vertical_align': 'middle', 'padding': 6, 'text_color': '#222222'})),
    )
