...
SOLVABLE = {'schema': 'modu.solvable.v1.2',
 ...
 'inputs': {'total_ticks': 0,
            ...
            'target_count': 1,
            'unit': ''},
 'given': [{'ref': 'obj.scissors', 'value': {'name': '가위'}},
 ...
 'steps': [{'id': 'step.1', 'expr': '그림의 대상 확인', 'value': ['가위', '책가방', '책가방']},
 ...
 'answer': {'blanks': [],
            ...
            'value': '2번 책가방',
            'unit': ''},
 'understanding': {'summary': 'Find 무게가 더 무거운 것 using the given information.',
                   'facts': [{'ref': 'obj.scissors',
                              'label': 'scissors',
                              'value': {'name': '가위'},
                              'unit': '',
                              'source': 'explicit'},
                   ...
                   'unknowns': [{'ref': 'answer.target',
                                 ...
                                 'unit': '',
                                 'source': 'unknown'}],
                   'relation': {'type': 'visual_weight_comparison',
                                'statement': '그림에 있는 물체들을 확인한다.',
                                'symbolic': '그림의 대상 확인',
                                'uses': ['obj.scissors', 'obj.bag.left', 'obj.bag.right'],
                                'result': 'answer.target'},
                   'diagnostic_questions': [{'id': 'understand.target',
                                             'type': 'multiple_choice',
                                             'prompt': 'What should we find?',
                                             'choices': ['scissors', 'left', '무게가 더 무거운 것'],
                                             'answer_index': 2}]}}
