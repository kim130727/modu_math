...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        title=PROBLEM_TITLE,
        canvas=Canvas(
            width = 700, height = 190, coordinate_mode="logical",
        ),
        regions=(
            Region(
                id="region.stem",
                ...
                slot_ids=("slot.question",
                    "slot.expression",
                    "slot.answer",'konva_1786192274303_rect_374282', 'konva_1786192274303_text_391859'),
            ),
        ),
        slots=(TextBoxSlot(
                id="slot.question",
            ...
            BlankSlot(
                ...
                answer_key="347",
                placeholder="개",
            ),RectSlot(id = 'konva_1786192274303_rect_374282', prompt = '', x = 405.164, y = 132.787, width = 126.148, height = 45.836, fill = '#ffffff', stroke = '#111827', stroke_width = 1.2, interaction = {'type': 'input', 'role': 'answer', 'value_type': 'digit', 'max_length': 1, 'include_in_submission': True, 'order': 0, 'group_id': 'final_answer', 'auto_advance': True, 'keyboard': 'number'}, input_style = {'font_size_mode': 'auto', 'font_size_adjust': 0, 'min_font_size': 14, 'max_font_size': 52, 'font_weight': 700, 'horizontal_align': 'center', 'vertical_align': 'middle', 'padding': 6, 'text_color': '#222222'}), TextBoxSlot(id = 'konva_1786192274303_text_391859', prompt = '', text = '개', x = 537.787, y = 135.902, font_size = 30, fill = '#111827', width = 38.246, height = 46, align = 'left', line_height = 1.25)),
    )
