...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        regions=(
            ...
            Region(id="region.answer", role="supporting_text", flow="absolute", slot_ids=()),
        ),
        slots=(
            TextSlot(
                id="slot.q.text",
                prompt="",
                text="나머지가 더 큰 것을 찾아 선택해 보세요.",
                style_role="question",
                x=90,
                y=50,
                font_size=30,
...
SEMANTIC_OVERRIDE = {
    ...
    "domain": {
        ...
        "problem_solving": {
            ...
            "execute": {"expected_operations": ["identify_remainders", "compare_values"]},
