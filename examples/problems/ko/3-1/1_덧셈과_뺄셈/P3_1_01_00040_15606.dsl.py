        ...
        regions=(
            Region(
                ...
                slot_ids=("slot.question",
                    "slot.expression",
                    "slot.answer",'konva_1786192274303_paste_522010_0', 'konva_1786192274303_paste_522010_1'),
            ),
        ),
        slots=(TextBoxSlot(
                id="slot.question",
                x = 12.465, y = 11.509, width = 570.082, height = 139, text=(
            ...
            BlankSlot(
                ...
                answer_key="377",
                placeholder="개",
            ),RectSlot(id = 'konva_1786192274303_paste_522010_0', prompt = '', x = 321.951, y = 171.295, width = 126.148, height = 45.836, fill = '#ffffff', stroke = '#111827', stroke_width = 1.2, interaction = {'type': 'input', 'role': 'answer', 'value_type': 'digit', 'max_length': 1, 'include_in_submission': True, 'order': 0, 'group_id': 'final_answer', 'auto_advance': True, 'keyboard': 'number'}, input_style = {'font_size_mode': 'auto', 'font_size_adjust': 0, 'min_font_size': 14, 'max_font_size': 52, 'font_weight': 700, 'horizontal_align': 'center', 'vertical_align': 'middle', 'padding': 6, 'text_color': '#222222'}), TextBoxSlot(id = 'konva_1786192274303_paste_522010_1', prompt = '', text = '개', x = 464.902, y = 174.902, font_size = 30, fill = '#111827', width = 38.246, height = 46, align = 'left', line_height = 1.25)),
    )
