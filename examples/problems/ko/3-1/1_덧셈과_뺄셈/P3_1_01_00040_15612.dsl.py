    ...
    return ProblemTemplate(
        ...
        regions=(
            Region(
                ...
                role="stem",
                flow="absolute",
                slot_ids=("slot.question",'konva_1786192274303_paste_953794_0'),
            ),
            Region(
                id="region.choices",
                role="choices",
        ...
        slots=(TextSlot(
            ...
            BlankSlot(
                ...
                answer_key="4",
                placeholder="번",
            ),TextBoxSlot(id = 'konva_1786192274303_paste_953794_0', prompt = '', text = '(   )', x = 311.853, y = 159.18, font_size = 21, fill = '#202124', width = 47.295, height = 35, align = 'left', line_height = 1.25, interaction = {'type': 'input', 'role': 'answer', 'value_type': 'digit', 'max_length': 1, 'include_in_submission': True, 'order': 0, 'group_id': 'final_answer', 'auto_advance': True, 'keyboard': 'number'}, input_style = {'font_size_mode': 'auto', 'font_size_adjust': 0, 'min_font_size': 14, 'max_font_size': 52, 'font_weight': 700, 'horizontal_align': 'center', 'vertical_align': 'middle', 'padding': 6, 'text_color': '#222222'})),
    )
