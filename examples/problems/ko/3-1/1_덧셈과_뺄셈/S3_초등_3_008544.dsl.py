    ...
    return ProblemTemplate(
        ...
        regions=(
            Region(
                ...
                role="stem",
                flow="absolute",
                slot_ids=("slot.q.text", "slot.box", "slot.expr1.body", "slot.expr2.body", "slot.expr3.body", "slot.choice1.num", "slot.choice2.num", "slot.choice3.num", "slot.choice4.num"),
            ),
        ),
        slots=(
            TextSlot(
    ...
    "diagnostic_questions": [
        {
            ...
            {"id": "choice.2", "label": "438", "text": "438"},
            {"id": "choice.3", "label": "520", "text": "520"},
            {"id": "choice.4", "label": "765", "text": "765"}
        ],
            "answer_index": 2,
        },
        {
            ...
            "choices": [
            {"id": "choice.1", "label": "choices", "text": "choices"},
            {"id": "choice.2", "label": "765, 520, 438", "text": "765, 520, 438"},
            {"id": "choice.3", "label": "520, 765, 438", "text": "520, 765, 438"},
            {"id": "choice.4", "label": "438, 520, 765", "text": "438, 520, 765"}
        ],
            "answer_index": 0,
        },
    ],
