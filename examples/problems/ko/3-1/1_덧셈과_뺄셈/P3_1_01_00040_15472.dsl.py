...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        title=PROBLEM_TITLE,
        canvas=Canvas(
            width = 450, height = 230, coordinate_mode="logical",
        ),
        regions=(
            Region(
                id="region.stem",
        ...
        slots=(TextBoxSlot(
            ...
            BlankSlot(
                ...
                answer_key="415",
                placeholder="수",
            ),RectSlot(id = 'konva_1785217709470_rect_5693830', prompt = '', x = 35.191, y = 128.594, width = 71.148, height = 35.628, fill = '#ffffff', stroke = '#111827', stroke_width = 1.2, interaction = {'type': 'input', 'role': 'answer', 'value_type': 'integer', 'max_length': 3, 'include_in_submission': True, 'order': 0, 'group_id': 'final_answer', 'auto_advance': True, 'keyboard': 'number'}, input_style = {'font_size_mode': 'auto', 'font_size_adjust': 0, 'min_font_size': 14, 'max_font_size': 52, 'font_weight': 700, 'horizontal_align': 'center', 'vertical_align': 'middle', 'padding': 6, 'text_color': '#222222'}), RectSlot(id = 'konva_1785217709470_paste_5710048_0', prompt = '', x = 162.249, y = 127.489, width = 71.148, height = 35.628, fill = '#ffffff', stroke = '#111827', stroke_width = 1.2, interaction = {'type': 'input', 'role': 'answer', 'value_type': 'integer', 'max_length': 3, 'include_in_submission': True, 'order': 1, 'group_id': 'final_answer', 'auto_advance': True, 'keyboard': 'number'}, input_style = {'font_size_mode': 'auto', 'font_size_adjust': 0, 'min_font_size': 14, 'max_font_size': 52, 'font_weight': 700, 'horizontal_align': 'center', 'vertical_align': 'middle', 'padding': 6, 'text_color': '#222222'})),
    )
