...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        title=PROBLEM_TITLE,
        canvas=Canvas(
            width = 500, height = 300, coordinate_mode="logical",
        ),
        regions=(
            Region(
                id="region.stem",
            ...
            Region(
                ...
                slot_ids=("slot.item_1_label",
                    ...
                    "slot.item_2_right_value",'konva_1785217709470_rect_934908', 'konva_1785217709470_paste_949846_0'),
            ),
        ),
        slots=(TextBoxSlot(
                id="slot.instruction",
            ...
            BlankSlot(
                ...
                answer_key="1305",
                placeholder="",
            ),RectSlot(id = 'konva_1785217709470_rect_934908', prompt = '', x = 217.779, y = 177.56, width = 54.115, height = 28.861, fill = '#ffffff', stroke = '#111827', stroke_width = 1.2, interaction = {'type': 'input', 'role': 'answer', 'value_type': 'digit', 'max_length': 1, 'include_in_submission': True, 'order': 0, 'group_id': 'final_answer', 'auto_advance': True, 'keyboard': 'number'}, input_style = {'font_size_mode': 'auto', 'font_size_adjust': 0, 'min_font_size': 14, 'max_font_size': 52, 'font_weight': 700, 'horizontal_align': 'center', 'vertical_align': 'middle', 'padding': 6, 'text_color': '#222222'}), RectSlot(id = 'konva_1785217709470_paste_949846_0', prompt = '', x = 370.614, y = 176.4, width = 54.115, height = 28.861, fill = '#ffffff', stroke = '#111827', stroke_width = 1.2, interaction = {'type': 'input', 'role': 'answer', 'value_type': 'digit', 'max_length': 1, 'include_in_submission': True, 'order': 1, 'group_id': 'final_answer', 'auto_advance': True, 'keyboard': 'number'}, input_style = {'font_size_mode': 'auto', 'font_size_adjust': 0, 'min_font_size': 14, 'max_font_size': 52, 'font_weight': 700, 'horizontal_align': 'center', 'vertical_align': 'middle', 'padding': 6, 'text_color': '#222222'})),
        diagrams=(),
        groups=(
            Group(
                id="group.example",
