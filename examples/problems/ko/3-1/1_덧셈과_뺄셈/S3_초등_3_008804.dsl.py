...
SOLVABLE = {'schema': 'modu.solvable.v1.2',
 ...
 'answer': {'blanks': [],
            ...
            'value': '모자',
            'unit': ''},
 'understanding': {'summary': 'Find 가장 가벼운 것 using the given information.',
                   'facts': [{'ref': 'obj.wallet',
                              'label': 'wallet',
                              'value': {'name': '지갑', 'coin_count': 9},
                              'unit': '500원짜리 동전의 수',
                              'source': 'explicit'},
                             {'ref': 'obj.hat',
                              'label': 'hat',
                              'value': {'name': '모자', 'coin_count': 2},
                              'unit': '500원짜리 동전의 수',
                              'source': 'explicit'},
                             {'ref': 'obj.bag',
                              'label': 'bag',
                              'value': {'name': '가방', 'coin_count': 13},
                              'unit': '500원짜리 동전의 수',
                              'source': 'explicit'}],
                   'unknowns': [{'ref': 'answer.target',
                                 ...
                                 'unit': '500원짜리 동전의 수',
                                 'source': 'unknown'}],
                   'relation': {'type': 'compare_coin_counts',
                                'statement': '각 물건에 해당하는 500원짜리 동전의 수를 비교한다.',
                                'symbolic': '지갑=9, 모자=2, 가방=13',
                                'uses': ['obj.wallet', 'obj.hat', 'obj.bag'],
                                'result': 'answer.target'},
                   'diagnostic_questions': [{'id': 'understand.target',
                                             'type': 'multiple_choice',
                                             'prompt': 'What should we find?',
                                             'choices': ['wallet', 'hat', '가장 가벼운 것'],
                                             'answer_index': 2}]}}
