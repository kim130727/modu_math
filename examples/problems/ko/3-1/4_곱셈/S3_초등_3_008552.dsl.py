    ...
    return ProblemTemplate(
        ...
        regions=(
            ...
            Region(
                ...
                role="diagram",
                flow="absolute",
                slot_ids=("slot.box", "slot.a.expr", "slot.b.expr", "slot.c.expr"),
            ),
            Region(
                id="region.options",
                role="choices",
                flow="absolute",
                slot_ids=("slot.opt1.text", "slot.opt2.text", "slot.opt3.text", "slot.opt4.text"),
            ),
            Region(
                id="region.answer",
                role="answer",
...
SEMANTIC_OVERRIDE = {
    ...
    "domain": {
        ...
        "problem_solving": {
            ...
            "review": {"check_methods": ["descending_order_check", "option_match_check"]},
        },
    },
    "answer": {
        "blanks": [],
