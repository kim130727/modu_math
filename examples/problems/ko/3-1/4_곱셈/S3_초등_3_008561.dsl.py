    ...
    return ProblemTemplate(
        ...
        regions=(
            ...
            Region(
                ...
                role="diagram",
                flow="absolute",
                slot_ids=("slot.road", "slot.road_dash", "slot.car1.body", "slot.car1.roof", "slot.car1.wheel1", "slot.car1.wheel2", "slot.car1.window", "slot.car1.text", "slot.car2.body", "slot.car2.roof", "slot.car2.wheel1", "slot.car2.wheel2", "slot.car2.window", "slot.car2.text", "slot.car3.body", "slot.car3.roof", "slot.car3.wheel1", "slot.car3.wheel2", "slot.car3.window", "slot.car3.text"),
            ),
            Region(
                id="region.answer",
                role="answer",
