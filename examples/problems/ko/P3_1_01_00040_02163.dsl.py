...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        title=PROBLEM_TITLE,
        canvas=Canvas(
            width = 380, height = 165, coordinate_mode="logical",
        ),
        regions=(
            Region(
                id="region.stem",
            ...
            Region(
                ...
                slot_ids=("slot.label_1",
                    ...
                    "slot.line_2",
                    "slot.number_2_answer",'konva_1785217709470_rect_1077876', 'konva_1785217709470_paste_1095824_0', 'konva_1785217709470_paste_1096221_0', 'konva_1785217709470_paste_1096698_0'),
            ),
        ),
        slots=(TextBoxSlot(
                id="slot.instruction",
                ...
                x=18,
                y=7,
                width = 342, height = 27.4, font_size=17,
                line_height=1.2,
                fill="#111111",
                align="left",
            ),
            ...
            TextSlot(
                ...
                text = '6  5  3', prompt="첫 번째 덧셈의 위 수 653",
                x = 121.703, y=48,
                font_size=22,
                anchor="end",
                fill="#111111",
            ...
            TextSlot(
                ...
                text = '3  1', prompt="첫 번째 덧셈 결과의 십의 자리와 일의 자리 31",
                x = 116.924, y = 142.49, font_size=22,
                anchor="end",
                fill="#111111",
            ),
            # ---------------------------------------------------------
            ...
            TextSlot(
                ...
                text = '2  5', prompt="두 번째 덧셈 위 수의 십의 자리와 일의 자리 25",
                x = 253.274, y = 73.702, font_size=22,
                anchor="end",
                fill="#111111",
            ),
            TextSlot(
            ...
            TextSlot(
                ...
                text = '8  0  4', prompt="두 번째 덧셈의 결과 804",
                x = 254.617, y = 145.02, font_size=22,
                anchor="end",
                fill="#111111",
            ),
            # 실제 정답 데이터용 빈칸 슬롯
            ...
            BlankSlot(
                ...
                answer_key="7",
                placeholder="",
            ),RectSlot(id = 'konva_1785217709470_rect_1077876', prompt = '', x = 188.34, y = 54.382, width = 16.979, height = 18.131, fill = '#ffffff', stroke = '#111827', stroke_width = 1.2), RectSlot(id = 'konva_1785217709470_paste_1095824_0', prompt = '', x = 210.196, y = 83.424, width = 16.965, height = 18.116, fill = '#ffffff', stroke = '#111827', stroke_width = 1.2), RectSlot(id = 'konva_1785217709470_paste_1096221_0', prompt = '', x = 84.005, y = 83.962, width = 16.579, height = 17.703, fill = '#ffffff', stroke = '#111827', stroke_width = 1.2), RectSlot(id = 'konva_1785217709470_paste_1096698_0', prompt = '', x = 63.371, y = 126.084, width = 16.534, height = 17.656, fill = '#ffffff', stroke = '#111827', stroke_width = 1.2)),
        diagrams=(),
        groups=(
            Group(
                id="group.problem_1",
