...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        title=PROBLEM_TITLE,
        canvas=Canvas(
            width = 200, height = 150, coordinate_mode="logical",
        ),
        regions=(
            Region(
                id="region.stem",
        ...
        slots=(
            TextBoxSlot(
                ...
                x = 11.2, y = 17, width=290,
                height = 26, font_size=14,
            ...
            TextSlot(
                ...
                prompt="첫 번째 수 431",
                text = '4  3  1', semantic_role="given_number",
                x = 49.2, y = 54, font_size=15,
                fill="#111111",
            ),
            TextSlot(
                id="slot.plus",
            ...
            LineSlot(
                ...
                x1 = 22.2, y1 = 85, x2 = 90.2, y2 = 85, stroke="#111111",
                stroke_width=1,
            ),
            RectSlot(
            ...
            TextSlot(
                ...
                text = '6  2', semantic_role="result_digits",
                x = 64.2, y = 106, font_size=15,
                fill="#111111",
            ),
            BlankSlot(
                id="slot.blank1",
