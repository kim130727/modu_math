    ...
    return ProblemTemplate(
        ...
        regions=(
            ...
            Region(
                ...
                role="diagram",
                flow="absolute",
                slot_ids=("slot.cloud1.core", "slot.cloud1.text", "slot.cloud2.core", "slot.cloud2.text", "slot.cloud3.core", "slot.cloud3.text", "slot.cloud4.core", "slot.cloud4.text"),
            ),
            Region(
                id="region.note",
                role="supporting",
        ...
        slots=(
            TextSlot(
                id="slot.qtext",
                prompt="",
                text="계산 결과가 2000보다 큰 곱셈식을 선택해 보세요.",
                style_role="question",
                x=166.022,
                y=87,
                font_size=25,
