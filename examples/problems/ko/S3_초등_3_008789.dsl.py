...
SOLVABLE = {'schema': 'modu.solvable.v1.2',
 ...
 'inputs': {'total_ticks': 0,
            ...
            'target_count': 2,
            'unit': ''},
 'given': [{'ref': 'obj.tharmos', 'value': {'name': '보온병'}},
 ...
 'plan': ['같은 그릇에 옮겨 담은 뒤의 물 양을 비교한다.', '더 많은 물이 담기는 쪽을 들이가 더 큰 것으로 판단한다.'],
 'method': 'visual_compare',
 'steps': [{'id': 'step.1',
 ...
 'answer': {'blanks': [],
            'choices': [],
            'answer_key': [],
            'target': {'type': 'greater_capacity_choice', 'description': '보온병과 우유갑 중 들이가 더 많은 것'},
            'value': 1,
            'unit': ''},
 'understanding': {'summary': 'Find 들이가 더 많은 것 using the given information.',
                   'facts': [{'ref': 'obj.tharmos',
                              'label': 'tharmos',
                              'value': {'name': '보온병'},
                              'unit': '',
                              'source': 'explicit'},
                             {'ref': 'obj.milk_carton',
                              ...
                              'unit': '',
                              'source': 'explicit'},
                             {'ref': 'obj.comparison_container',
                              'label': 'comparison container',
                              'value': {'name': '같은 그릇'},
                              'unit': '',
                              'source': 'explicit'}],
                   'unknowns': [{'ref': 'answer.target',
                                 ...
                                 'unit': '',
                                 'source': 'unknown'}],
                   'relation': {'type': 'visual_compare',
                                'statement': '같은 그릇에 옮겨 담은 뒤의 물 양을 비교한다.',
                                'symbolic': '보온병과 우유갑을 같은 그릇에 옮겨 담은 뒤 물의 양을 비교한다.',
                                'uses': ['obj.tharmos',
                                         'obj.milk_carton',
                                         'obj.comparison_container'],
                                'result': 'answer.target'},
                   'diagnostic_questions': [{'id': 'understand.target',
                                             'type': 'multiple_choice',
                                             'prompt': 'What should we find?',
                                             'choices': ['tharmos', 'milk carton', '들이가 더 많은 것'],
                                             'answer_index': 2}]}}
