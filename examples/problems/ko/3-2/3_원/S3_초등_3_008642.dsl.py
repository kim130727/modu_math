    ...
    return ProblemTemplate(
        ...
        slots=(
            TextSlot(
                id="slot.q1",
                prompt="",
                text="은지, 진아, 현준이가 한 원에 지름을 그은 것입니다.",
                style_role="question",
                x=20,
                y=40,
                font_size=30,
            ...
            TextSlot(
                id="slot.q2",
                prompt="",
                text="한 원에 지름을 몇 개 그을 수 있는지 알맞은 것을 선택하세요.",
                style_role="question",
                x=20,
                y=100,
                font_size=30,
            ...
            PathSlot(
                id="slot.note.arrow",
                prompt="",
                d="M 390.171 324.28 L 616.171 314.17 M 616.171 314.17 L 606.481 319.38 M 616.171 314.17 L 606.061 309.84",
                fill="none",
                stroke="#111827",
                stroke_width=1.2,
            ),
...
SEMANTIC_OVERRIDE = {
    ...
    "metadata": {
        "language": "ko",
        "question": "은지, 진아, 현준이가 한 원에 지름을 그은 것입니다. 한 원에 지름을 몇 개 그을 수 있는지 알맞은 것을 선택하세요.",
