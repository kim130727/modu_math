...
SOLVABLE = {'schema': 'modu.solvable.v1.2',
 ...
 'inputs': {'total_ticks': 1,
            ...
            'target_count': 1,
            'unit': ''},
 'given': [{'ref': 'obj.yuubyeong', 'value': {'name': '유우병'}},
           {'ref': 'obj.petbottle', 'value': {'name': '페트병'}}],
 'target': {'ref': 'answer.target', 'type': 'selected_container'},
 'method': 'compare_capacity_from_illustration',
 'plan': ['그림과 해설을 보고 더 많은 들이를 가진 용기를 고른다.'],
 'steps': [{'id': 'step.1', 'expr': '유우병에 가득 채운 물이 페트병에 가득 차는지 확인한다.', 'value': False},
           {'id': 'step.2', 'expr': '페트병에 가득 차지 않으므로 더 많은 들이를 가진 용기를 선택한다.', 'value': '페트병'}],
 'checks': [{'id': 'check.1',
 ...
 'answer': {'blanks': [],
            ...
            'value': '페트병',
            'unit': ''},
 'understanding': {'summary': 'Find 더 많은 들이 using the given information.',
                   'facts': [{'ref': 'obj.yuubyeong',
                              'label': 'yuubyeong',
                              'value': {'name': '유우병'},
                              'unit': '',
                              'source': 'explicit'},
                   ...
                   'unknowns': [{'ref': 'answer.target',
                                 ...
                                 'unit': '',
                                 'source': 'unknown'}],
                   'relation': {'type': 'compare_capacity_from_illustration',
                                'statement': '그림과 해설을 보고 더 많은 들이를 가진 용기를 고른다.',
                                'symbolic': '유우병에 가득 채운 물이 페트병에 가득 차는지 확인한다.',
                                'uses': ['obj.yuubyeong', 'obj.petbottle'],
                                'result': 'answer.target'},
                   'diagnostic_questions': [{'id': 'understand.target',
                                             'type': 'multiple_choice',
                                             'prompt': 'What should we find?',
                                             'choices': ['yuubyeong', 'petbottle', '더 많은 들이'],
                                             'answer_index': 2}]}}
