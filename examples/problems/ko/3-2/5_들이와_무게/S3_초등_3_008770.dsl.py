...
SOLVABLE = {'schema': 'modu.solvable.v1.2',
 ...
 'inputs': {'total_ticks': 0,
            ...
            'target_count': 1,
            'unit': 'kg'},
 'given': [{'ref': 'obj.cat', 'value': {'name': '고양이'}},
 ...
 'plan': ['고양이의 무게에 비해 너무 가볍거나 너무 무거운 선택지를 제외한다.', '가장 알맞은 무게를 고른다.'],
 'method': 'mass_sense_comparison',
 'steps': [{'id': 'step.1', 'expr': '3 g, 3 kg, 3 t 중 고양이에 알맞은 무게를 비교한다', 'value': '비교'},
 ...
 'answer': {'blanks': [],
            ...
            'value': 3,
            'unit': 'kg'},
 'understanding': {'summary': 'Find 무게를 알맞게 어림한 것 using the given information.',
                   'facts': [{'ref': 'obj.cat',
                              'label': 'cat',
                              'value': {'name': '고양이'},
                              'unit': 'kg',
                   ...
                   'unknowns': [{'ref': 'answer.target',
                                 ...
                                 'unit': 'kg',
                                 'source': 'unknown'}],
                   'relation': {'type': 'mass_sense_comparison',
                                'statement': '고양이의 무게에 비해 너무 가볍거나 너무 무거운 선택지를 제외한다.',
                                'symbolic': '3 g, 3 kg, 3 t 중 고양이에 알맞은 무게를 비교한다',
                                'uses': ['obj.cat', 'obj.choice_1', 'obj.choice_2', 'obj.choice_3'],
                                'result': 'answer.target'},
                   'diagnostic_questions': [{'id': 'understand.target',
                                             'type': 'multiple_choice',
                                             'prompt': 'What should we find?',
                                             'choices': ['cat', 'choice 1', '무게를 알맞게 어림한 것'],
                                             'answer_index': 2}]}}
