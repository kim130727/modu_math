...
SOLVABLE = {'schema': 'modu.solvable.v1.2',
 ...
 'inputs': {'total_ticks': 3,
            ...
            'target_count': 2,
            'unit': 'L'},
 'given': [{'ref': 'obj.bottle.ga', 'value': {'l': 1, 'ml': 700}},
 ...
 'steps': [{'id': 'step.1', 'expr': '1 L 700 mL + 1 L 300 mL', 'value': {'l': 3, 'ml': 0}},
 ...
 'answer': {'blanks': [],
            'choices': [],
            'answer_key': [],
            'target': {'type': 'selected_bottles', 'description': '3 L가 되게 하는 물병의 조합', 'count': 2},
            'value': '가, 다',
            'unit': ''},
 'understanding': {'summary': 'Find 3 L using the given information.',
                   ...
                   'unknowns': [{'ref': 'answer.target',
                                 ...
                                 'unit': 'L',
                                 'source': 'unknown'}],
                   'relation': {'type': 'pair_selection',
                                'statement': '각 물병의 용량을 비교한다.',
                                'symbolic': '1 L 700 mL + 1 L 300 mL',
                                'uses': ['obj.bottle.ga', 'obj.bottle.na', 'obj.bottle.da'],
