...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        title=PROBLEM_TITLE,
        canvas=Canvas(
            width = 300, height = 145, coordinate_mode="logical",
        ),
        regions=(
            Region(
                id="region.stem",
            ...
            Region(
                ...
                slot_ids=("slot.label_1",
                    ...
                    "slot.plus_2",
                    "slot.addend_2_2",
                    "slot.line_2",'konva_1785217709470_rect_1652380', 'konva_1785217709470_paste_1665223_0', 'konva_1786944463263_rect_1518102'),
            ),
        ),
        slots=(TextBoxSlot(
                id="slot.instruction",
            ...
            TextSlot(
                id="slot.addend_1_1",
                text = '2 3 5', prompt="첫 번째 덧셈의 위 수 235",
                x = 105.441, y = 65.066, font_size=21,
                anchor="end",
                fill="#111111",
            ),
            TextSlot(
            ...
            TextSlot(
                id="slot.addend_1_2",
                text = '4 8 6', prompt="첫 번째 덧셈의 아래 수 486",
                x = 105.58, y = 93.342, font_size=21,
                anchor="end",
                fill="#111111",
            ),
            LineSlot(
            ...
            TextSlot(
                id="slot.addend_2_1",
                text = '5 2 9', prompt="두 번째 덧셈의 위 수 529",
                x = 227.149, y = 65.066, font_size=21,
                anchor="end",
                fill="#111111",
            ),
            TextSlot(
            ...
            TextSlot(
                id="slot.addend_2_2",
                text = '8 9 8', prompt="두 번째 덧셈의 아래 수 898",
                x = 228.01, y=80,
                font_size=21,
                anchor="end",
                fill="#111111",
