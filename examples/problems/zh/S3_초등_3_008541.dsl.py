...
SEMANTIC_OVERRIDE = {
    ...
    "domain": {
        "objects": [
            {"id": "obj.a", "type": "expression", "label": "甲", "operation": "397 × 6"},
            {"id": "obj.b", "type": "expression", "label": "乙", "operation": "549 × 4"},
            {"id": "obj.c", "type": "expression", "label": "丙", "operation": "456 × 5"},
            {"id": "obj.option2", "type": "choice", "label": "②", "sequence": ["甲", "丙", "乙"]},
        ],
        "relations": [
...
SOLVABLE = {
    ...
    "given": [
        {"ref": "obj.a", "value": {"label": "甲", "expr": "397 × 6"}},
        {"ref": "obj.b", "value": {"label": "乙", "expr": "549 × 4"}},
        {"ref": "obj.c", "value": {"label": "丙", "expr": "456 × 5"}},
    ],
    "target": {"ref": "answer.target", "type": "choice_number"},
    "method": "compare_results_descending",
    "plan": ["计算各乘法算式的结果，并按从大到小的顺序比较。", "找出与比较顺序相同的选项编号。"],
    "steps": [
        {"id": "step.1", "expr": "397 × 6", "value": 2382},
        {"id": "step.2", "expr": "549 × 4", "value": 2196},
        {"id": "step.3", "expr": "456 × 5", "value": 2280},
        {"id": "step.4", "expr": "2382 > 2280 > 2196", "value": "甲, 丙, 乙"},
