...
def build_problem_template() -> ProblemTemplate:
    ...
    slots = (
        TextBoxSlot(
            id="slot.question",
            prompt="",
            text="将甲、乙两个水瓶装满水后，把水倒入形状和大小相同的容器中。根据图中所示的水面高度，比较甲、乙水瓶的容量。请选择正确的词语。",
            style_role="question",
            x=66.684,
            y=17.307,
            width=825.55,
...
SEMANTIC_OVERRIDE = {
    ...
    "metadata": {
        "language": "ko",
        "question": "比较甲、乙水瓶的容量。",
        "instruction": "请选择正确的词语。",
    },
    "domain": {
        "objects": [
            {"id": "obj.bottle.ga", "type": "물병", "label": "甲水瓶"},
            {"id": "obj.bottle.na", "type": "물병", "label": "乙水瓶"},
            {
...
SOLVABLE = {
    ...
    "plan": ["比较倒入相同形状和大小容器中的水面高度。", "判断水面较高的一方容量更大。"],
    "steps": [
