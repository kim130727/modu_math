...
SOLVABLE = {'schema': 'modu.solvable.v1.2',
 ...
 'inputs': {'total_ticks': 0,
            ...
            'target_count': 2,
            'unit': ''},
 'given': [{'ref': 'obj.water_bottle', 'value': {'name': '물병'}},
           {'ref': 'obj.pet_bottle', 'value': {'name': '페트병'}},
           {'ref': 'rel.pour_water', 'value': {'from': '물병', 'to': '페트병'}}],
 'target': {'ref': 'answer.target', 'type': 'choice'},
 'method': 'visual_comparison',
 'plan': ['그림에서 비교 대상인 물병과 페트병을 찾는다.', '물이 옮겨진 뒤의 상태를 보고 어느 용기가 더 큰 들이를 가지는지 판단한다.'],
 'steps': [{'id': 'step.1', 'expr': '비교 대상 확인', 'value': ['물병', '페트병']},
 ...
 'understanding': {'summary': 'Find 들이가 더 많은 것 using the given information.',
                   ...
                   'relation': {'type': 'visual_comparison',
                                'statement': '그림에서 비교 대상인 물병과 페트병을 찾는다.',
                                'symbolic': '비교 대상 확인',
                                'uses': ['obj.water_bottle', 'obj.pet_bottle', 'rel.pour_water'],
                                'result': 'answer.target'},
                   'diagnostic_questions': [{'id': 'understand.target',
                                             'type': 'multiple_choice',
                                             'prompt': 'What should we find?',
                                             'choices': ['water bottle',
                                                         'pet bottle',
                                                         '들이가 더 많은 것'],
                                             'answer_index': 2}]}}
