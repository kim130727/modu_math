...
def build_problem_template() -> ProblemTemplate:
    ...
    slots = (
        TextBoxSlot(
            ...
            prompt="",
            text=(
                "Накресліть коло за допомогою канцелярської кнопки та паперової смужки. Виберіть "
                "позначення отвору, у який слід вставити олівець, щоб накреслити найбільше коло."
            ),
            style_role="question",
            x=37.211,
            y=23.106,
    ...
    return ProblemTemplate(
        id="S3_초등_3_008664",
        title="Вибрати отвір для найбільшого кола",
        canvas=canvas,
        regions=regions,
        slots=slots,
        diagrams=diagrams,
...
SEMANTIC_OVERRIDE = {
    ...
    "metadata": {
        "language": "ko",
        "question": "Накресліть коло за допомогою канцелярської кнопки та паперової смужки. "
        "Виберіть позначення отвору, у який слід вставити олівець, щоб "
        "накреслити найбільше коло.",
        "instruction": "Виберіть позначення отвору.",
        "points": 5,
    },
    "domain": {
        "objects": [
...
SOLVABLE = {
    ...
    "method": "compare_hole_distances",
    "plan": [
        "Порівняйте розташування отворів.",
        "Знайдіть отвір, найдальший від кнопки до грифеля олівця.",
        "Запишіть позначення відповідного отвору як відповідь.",
    ],
    "steps": [
        {
            "id": "step.1",
