...
def build_problem_template() -> ProblemTemplate:
    ...
    slots = (
        TextSlot(
            id="slot.q1",
            prompt="",
            text="Виберіть добуток, який представляє зафарбована частина.",
            style_role="question",
            x=58.0,
            y=55.0,
            font_size=28,
    ...
    return ProblemTemplate(
        id="S3_elem_3_008540",
        title="Виберіть добуток, який представляє зафарбована частина.",
        canvas=canvas,
        regions=regions,
        slots=slots,
        diagrams=diagrams,
...
SOLVABLE = {
    ...
    "plan": [
        "Перевірте розрядне значення зафарбованої частини разом із поясненням.",
        "Знайдіть серед варіантів однаковий вираз.",
    ],
    "steps": [
