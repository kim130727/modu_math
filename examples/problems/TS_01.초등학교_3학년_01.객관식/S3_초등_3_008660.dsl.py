...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        regions=(
            ...
            Region(
                ...
                slot_ids=("slot.circle",
                    ...
                    "slot.seg.2",
                    "slot.seg.3",
                    "slot.seg.4",'slot.pt.c.copy5', 'slot.pt.c.copy6'),
            ),
            Region(
                id="region.choices",
                role="choices",
        ...
        slots=(TextSlot(
            ...
            CircleSlot(
                id="slot.center", prompt="", cx = 480, cy = 175, r = 5, fill="#ff4fa3"
            ),
            CircleSlot(
                id="slot.pt.a", prompt="", cx=418.0, cy=110.0, r=2.8, fill="#222222"
            ),
            CircleSlot(
                id="slot.pt.c", prompt="", cx = 560, cy = 215, r = 2.8, fill = '#222222', stroke = '#111111', stroke_width = 2),
            LineSlot(
                id="slot.seg.1",
                prompt="",
                x1 = 420, y1 = 110, x2 = 480, y2 = 175, stroke="#222222",
                stroke_width=1.5,
            ),
            LineSlot(
                id="slot.seg.2",
                prompt="",
                x1 = 420, y1 = 110, x2 = 500, y2 = 260, stroke="#222222",
                stroke_width=1.5,
            ),
            LineSlot(
                id="slot.seg.3",
                prompt="",
                x1 = 415, y1 = 235, x2 = 560, y2 = 215, stroke="#222222",
                stroke_width=1.5,
            ),
            LineSlot(
                id="slot.seg.4",
                prompt="",
                x1 = 415, y1 = 235, x2 = 480, y2 = 175, stroke="#222222",
                stroke_width=1.5,
            ),
            TextSlot(
                id="slot.lb.o",
                ...
                x = 475, y = 155, font_size = 25),
            TextSlot(
                id="slot.lb.ga",
                prompt="",
                text = 'ㄱ', style_role="label",
                x = 390, y = 110, font_size = 25),
            TextSlot(
                id="slot.lb.na",
                prompt="",
                text = 'ㄴ', style_role="label",
                x = 395, y = 255, font_size = 25),
            TextSlot(
                id="slot.lb.da",
                prompt="",
                text = 'ㄷ', style_role="label",
                x = 510, y = 280, font_size = 25),
            TextSlot(
                id="slot.lb.ra",
                prompt="",
                text = 'ㄹ', style_role="label",
                x = 590, y = 210, font_size = 25),
            TextSlot(
                id="slot.choice.ga",
                prompt="",
