...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        slots=(
            ...
            RectSlot(id="slot.scale.left_1", prompt="", x=248.0, y=178.0, width=84.0, height=36.0),
            RectSlot(id="slot.scale.right_1", prompt="", x=338.0, y=178.0, width=84.0, height=36.0),
            RectSlot(id="slot.scale.left_2", prompt="", x=587.0, y=178.0, width=84.0, height=36.0),
            RectSlot(id="slot.scale.right_2", prompt="", x=677.0, y=178.0, width=84.0, height=36.0),
        ),
        diagrams=(),
        groups=(),
        constraints=(),
