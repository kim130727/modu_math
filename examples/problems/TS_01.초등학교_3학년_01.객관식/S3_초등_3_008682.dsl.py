...
def build_problem_template() -> ProblemTemplate:
    ...
    return ProblemTemplate(
        ...
        regions=(
            Region(id="region.stem", role="stem", flow="absolute", slot_ids=("slot.q_num", "slot.q1", "slot.q2")),
            Region(
                id="region.diagram",
                role="diagram",
                flow="absolute",
        ...
        slots=(
            TextSlot(id="slot.q_num", prompt="", text="66.", style_role="question", x=12.0, y=34.0, font_size=28),
            TextSlot(
                id="slot.q1",
                prompt="",
                text="주어진 모양과 똑같은 그림을 그리는 방법을 설명한 것입니다. 알맞은 말을",
                style_role="question",
                x=74.0,
                y=34.0,
                font_size=28,
            ),
            TextSlot(id="slot.q2", prompt="", text="선택하세요.", style_role="question", x=74.0, y=70.0, font_size=28),
            *left_grid,
            _circle_on_grid(
                "slot.left.outer_circle",
                grid_x=left_x,
