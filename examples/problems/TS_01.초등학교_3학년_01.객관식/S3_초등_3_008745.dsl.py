    ...
    return ProblemTemplate(
        ...
        regions=(
            ...
            Region(
                ...
                flow="absolute",
                slot_ids=(
                    "slot.diagram.left.bottle",
                    "slot.diagram.left.bucket",
                    "slot.diagram.right.bottle",
                    "slot.diagram.right.bucket",
                    "slot.diagram.label.ga",
                    "slot.diagram.label.na",
                    "slot.diagram.left.water",
                    "slot.diagram.right.water",
                ),
            ),
            Region(
                id="region.choice",
        ...
        slots=(
            TextSlot(
                id="slot.q1",
                prompt="",
                text="□ 42.  가 물병과 나 물병에 물을 가득 채운 후 모양과 크기가 같은 그릇에 옮겨",
                style_role="question",
                x=16.0,
                y=34.0,
                font_size=28,
            ...
            TextSlot(
                id="slot.q2",
                prompt="",
                text="담았습니다. 그림과 같이 물을 채웠을 때에 가 물병과 나 물병의 들이를 비교하",
                style_role="question",
                x=16.0,
                y=68.0,
                font_size=28,
            ...
            RectSlot(
                id="slot.diagram.left.bottle", prompt="", x=298.0, y=108.0, width=88.0, height=34.0
            ),
            RectSlot(
                id="slot.diagram.left.bucket", prompt="", x=364.0, y=176.0, width=92.0, height=70.0
            ),
            RectSlot(
                id="slot.diagram.right.bottle", prompt="", x=558.0, y=102.0, width=92.0, height=36.0
            ),
            RectSlot(
                id="slot.diagram.right.bucket", prompt="", x=530.0, y=172.0, width=96.0, height=76.0
            ),
            TextSlot(
            ...
            RectSlot(
                id="slot.diagram.left.water", prompt="", x=372.0, y=218.0, width=76.0, height=18.0
            ),
            RectSlot(
                id="slot.diagram.right.water", prompt="", x=538.0, y=208.0, width=80.0, height=28.0
            ),
            TextSlot(
                id="slot.choice.1",
                prompt="",
                text="(1) 옮겨 담은 물의 높이가 더 높은 것은 ( 가 물병, 나 물병)입니다.",
                style_role="question",
                x=36.0,
                y=314.0,
                font_size=28,
            ...
            TextSlot(
                id="slot.choice.2",
                prompt="",
                text="(2) 들이가 더 많은 것은 ( 가 물병, 나 물병)입니다.",
                style_role="question",
                x=36.0,
                y=350.0,
                font_size=28,
...
SEMANTIC_OVERRIDE = {
    ...
    "domain": {
        "objects": [
            {"id": "obj.bottle.ga", "type": "물병", "label": "가 물병"},
            {"id": "obj.bottle.na", "type": "물병", "label": "나 물병"},
            {
        ...
        "problem_solving": {
            ...
            "plan": {
                ...
                "description": "같은 모양과 크기의 그릇에 옮겨 담은 물의 높이를 비교하여 들이의 많고 적음을 판단한다.",
            },
            "execute": {
