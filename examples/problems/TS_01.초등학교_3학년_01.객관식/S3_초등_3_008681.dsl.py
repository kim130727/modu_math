...
def build_problem_template() -> ProblemTemplate:
    ...
    answer_ids, answer_slots = _make_option_block(
        prefix="slot.answer",
        ruler_x=58.0,
        ruler_y=364.0,
        right_mark_cm=3,
    ...
    return ProblemTemplate(
        ...
        regions=(
            ...
            Region(
                ...
                role="diagram",
                flow="absolute",
                slot_ids=("slot.answer.label",) + answer_ids,
            ),
            Region(
                id="region.explain",
                role="explanation",
                flow="absolute",
                slot_ids=("slot.explain.text",),
            ),
        ),
        slots=(
            TextSlot(
            ...
            TextSlot(
                ...
                prompt="",
                text="(해설) 오른쪽부터 차례로 2 cm, 1 cm, 3 cm만큼 벌렸습니다.",
                style_role="question",
                x=10.0,
                y=432.0,
                font_size=28,
