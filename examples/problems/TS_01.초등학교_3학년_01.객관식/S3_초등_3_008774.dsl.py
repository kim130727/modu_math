    ...
    return ProblemTemplate(
        ...
        slots=(
            TextSlot(
                id="slot.q1",
                prompt="",
                text="86. 다음과 같이 물병에 물이 가득 채워져 있습니다. 두 물병의 물을 모아 3 L가 되게 하려면 어느 물병을 골라야 하는지 모두 선택하세요.",
                style_role="question",
                x=18.0,
                y=26.0,
                font_size=28,
            ...
            RectSlot(id="slot.box", prompt="", x=110.0, y=84.0, width=740.0, height=212.0),
            TextSlot(
                id="slot.label.ga",
                prompt="",
                text="가",
            ...
            TextSlot(
                id="slot.cap.ga",
                prompt="",
                text="TODO 물병 세부 모양은 이미지 기준으로 보정 필요",
                style_role="note",
                x=150.0,
                y=190.0,
                font_size=16,
