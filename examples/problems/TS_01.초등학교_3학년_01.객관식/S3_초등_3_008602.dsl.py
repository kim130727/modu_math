...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        slots=(
            TextSlot(id="slot.q.no", prompt="", text="71.", style_role="question", x=12.0, y=28.0, font_size=28),
            TextSlot(id="slot.q.text", prompt="", text="나머지가 가장 작은 것을 찾아 기호를 선택하세요.", style_role="question", x=70.0, y=28.0, font_size=28),
