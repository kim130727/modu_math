    ...
    return ProblemTemplate(
        ...
        regions=(
            Region(
                ...
                role="stem",
                flow="absolute",
                slot_ids=("slot.q1", "slot.inserted.text_box.1", "slot.inserted.calloutRect.1"),
            ),
            Region(
                id="region.view_box",
                role="diagram",
        ...
        slots=(
            ...
            PathSlot(
                ...
                prompt="",
                d="M 290 130 L 410 130 L 410 195 L 370 195 L 345 215 L 350 195 L 290 195 Z",
                fill="#ffffff",
                stroke="#111827",
                stroke_width=1.5,
            ),
...
SEMANTIC_OVERRIDE = {
    ...
    "domain": {
        ...
        "problem_solving": {
            ...
            "execute": {"expected_operations": ["compute_multiplication", "compare_results"]},
