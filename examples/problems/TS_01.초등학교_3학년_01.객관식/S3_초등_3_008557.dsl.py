...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        slots=(
            ...
            TextSlot(id="slot.c1", prompt="", text="3 × 4", style_role="choice", x=240, y=385, font_size=40),
            TextSlot(id="slot.c2", prompt="", text="30 × 4", style_role="choice", x=385, y=385, font_size=40),
            TextSlot(id="slot.c3", prompt="", text=TARGET_EXPRESSION, style_role="choice", x=540, y=385, font_size=40),
        ),
        diagrams=(),
        groups=(),
        constraints=(),
