...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        regions=(
            Region(
                ...
                slot_ids=(
                    ...
                    "slot.scale.pivot",
                    "slot.scale.arm.left",
                    "slot.scale.arm.right",
                    "slot.scale.pan.left",
                    "slot.scale.pan.right",
                    "slot.scale.string.left",
                    "slot.scale.string.right",
                    "slot.scale.orange",
                    "slot.scale.banana",
                ),
            ),
        ...
        slots=(
            ...
            RectSlot(id="slot.lbl.orange", prompt="", x=410.0, y=100.0, width=64.0, height=26.0),
            RectSlot(id="slot.lbl.banana", prompt="", x=520.0, y=100.0, width=64.0, height=26.0),
            TextSlot(
                id="slot.scale.base",
                prompt="",
                text="",
            ...
            PathSlot(
                id="slot.scale.pivot",
                prompt="",
                d="M 465.0 124.0 L 470.0 124.0 L 470.0 168.0 L 465.0 168.0 Z",
            ),
            LineSlot(id="slot.scale.arm.left", prompt="", x1=469.0, y1=126.0, x2=430.0, y2=142.0),
            LineSlot(id="slot.scale.arm.right", prompt="", x1=471.0, y1=126.0, x2=515.0, y2=112.0),
            LineSlot(id="slot.scale.pan.left", prompt="", x1=417.0, y1=140.0, x2=442.0, y2=140.0),
            LineSlot(id="slot.scale.pan.right", prompt="", x1=506.0, y1=112.0, x2=532.0, y2=112.0),
            LineSlot(
                id="slot.scale.string.left", prompt="", x1=430.0, y1=142.0, x2=430.0, y2=170.0
            ),
            LineSlot(
                id="slot.scale.string.right", prompt="", x1=520.0, y1=112.0, x2=520.0, y2=170.0
            ),
            CircleSlot(
                id="slot.scale.orange", prompt="", cx=420.0, cy=132.0, r=22.0, fill="#F28C28"
            ),
            PathSlot(
                id="slot.scale.banana",
                prompt="",
                d="M 508.0 108.0 C 520.0 92.0, 544.0 92.0, 556.0 104.0 C 548.0 116.0, 530.0 123.0, 514.0 120.0 C 507.0 117.0, 504.0 111.0, 508.0 108.0 Z",
            ),
        ),
        diagrams=(),
        groups=(),
