    ...
    return ProblemTemplate(
        ...
        slots=(
            TextSlot(
                id="slot.q1",
                prompt="",
                text="□ 39. 눈물 못과 띠 종이를 사용하여 원을 그리려고 합니다.",
                style_role="question",
                x=15.0,
                y=22.0,
                font_size=28,
            ...
            TextSlot(
                id="slot.q2",
                prompt="",
                text="원을 가장 크게 그리려고 할 때 연필을 꽂아야 하는 구멍의 기호를 선택해 보세요.",
                style_role="question",
                x=15.0,
                y=57.0,
                font_size=28,
            ...
            CircleSlot(
                id="slot.tool", prompt="", cx=328.0, cy=141.0, r=9.0, fill="#7f8c99"
            ),
            CircleSlot(
                id="slot.hole.1",
                prompt="",
