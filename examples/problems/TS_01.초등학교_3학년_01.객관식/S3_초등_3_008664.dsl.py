...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        canvas=Canvas(width=951.0, height=360.0, coordinate_mode="logical"),
        regions=(
            Region(
                id="region.stem",
                role="stem",
        ...
        slots=(
            ...
            LineSlot(
                id="slot.link.1",
                prompt="",
                x1 = 275, y1 = 235, x2 = 275, y2 = 270, stroke="#ff6bb6",
                stroke_width=2.0,
            ),
            LineSlot(
                id="slot.link.2",
                prompt="",
                x1 = 340, y1 = 235, x2 = 340, y2 = 270, stroke="#ff6bb6",
                stroke_width=2.0,
            ),
            LineSlot(
                id="slot.link.3",
                prompt="",
                x1 = 400, y1 = 235, x2 = 400, y2 = 270, stroke="#ff6bb6",
                stroke_width=2.0,
            ),
            LineSlot(
                id="slot.link.4",
                prompt="",
                x1 = 460, y1 = 235, x2 = 460, y2 = 270, stroke="#ff6bb6",
                stroke_width=2.0,
            ),
            LineSlot(
                id="slot.link.5",
                prompt="",
                x1 = 525, y1 = 235, x2 = 525, y2 = 270, stroke="#ff6bb6",
                stroke_width=2.0,
            ),
            TextSlot(
                id="slot.choice.lb.1",
                ...
                x = 262, y = 290, font_size = 25, fill = '#111111'),
            TextSlot(
                id="slot.choice.lb.2",
                prompt="",
                text = '㉡', style_role="label",
                x = 327, y = 290, font_size = 25, fill = '#111111'),
            TextSlot(
                id="slot.choice.lb.3",
                prompt="",
                text = '㉢', style_role="label",
                x = 387, y = 290, font_size = 25, fill = '#111111'),
            TextSlot(
                id="slot.choice.lb.4",
                prompt="",
                text = '㉣', style_role="label",
                x = 447, y = 290, font_size = 25, fill = '#111111'),
            TextSlot(
                id="slot.choice.lb.5",
                prompt="",
                text = '㉤', style_role="label",
...
SEMANTIC_OVERRIDE = {
    ...
    "domain": {
        ...
        "problem_solving": {
            ...
            "execute": {
                "expected_operations": ["compare_positions", "select_farthest_hole"]
            },
