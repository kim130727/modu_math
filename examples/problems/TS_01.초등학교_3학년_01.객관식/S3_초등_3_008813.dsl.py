    ...
    return ProblemTemplate(
        ...
        slots=(
            TextSlot(
                id="slot.q1",
                prompt="",
                text="46. 우유병에 물을 가득 채운 후 컵에 옮겨 담았더니 우유병에 물이 남았습니다. 우유병과 컵 중에서 들이가 더 적은 것을 선택해 보세요.",
                style_role="question",
                x=14.0,
                y=22.0,
                font_size=28,
            ...
            RectSlot(id="slot.bottle.body", prompt="", x=268.0, y=78.0, width=38.0, height=92.0),
            RectSlot(id="slot.bottle.neck", prompt="", x=279.0, y=58.0, width=16.0, height=26.0),
            TextSlot(
            ...
            RectSlot(id="slot.bottle.fill", prompt="", x=270.0, y=118.0, width=34.0, height=48.0),
            RectSlot(id="slot.cup.body", prompt="", x=600.0, y=112.0, width=44.0, height=84.0),
            PathSlot(
                id="slot.cup.handle",
                prompt="",
                d="M 644.0 126.0 C 666.0 126.0, 666.0 170.0, 644.0 170.0",
            ),
            RectSlot(id="slot.cup.fill", prompt="", x=606.0, y=112.0, width=32.0, height=18.0),
            TextSlot(
                id="slot.arrow",
                prompt="",
                text="→",
            ...
            CircleSlot(id="slot.cap1", prompt="", cx=285.0, cy=50.0, r=8.0, fill="#ffffff"),
            CircleSlot(id="slot.cap2", prompt="", cx=285.0, cy=50.0, r=5.0, fill="#ffffff"),
            CircleSlot(id="slot.cap3", prompt="", cx=285.0, cy=50.0, r=3.0, fill="#ffffff"),
            CircleSlot(id="slot.cap4", prompt="", cx=285.0, cy=50.0, r=2.0, fill="#ffffff"),
            CircleSlot(id="slot.cap5", prompt="", cx=285.0, cy=50.0, r=1.5, fill="#ffffff"),
            CircleSlot(id="slot.cap6", prompt="", cx=285.0, cy=50.0, r=1.0, fill="#ffffff"),
            TextSlot(
                id="slot.choice",
                prompt="",
                text="( 우유병, 컵 )",
