...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        slots=(
            TextSlot(id="slot.qtext", prompt="", text="계산 결과가 2000보다 큰 곱셈식을 선택해 보세요.", style_role="question", x=84.0, y=24.0, font_size=24),
            RectSlot(id="slot.cloud1.core", prompt="", x = 90, y = 55, width=120.0, height=50.0, rx=20.0, ry=20.0),
            TextSlot(id="slot.cloud1.text", prompt="", text="19 × 90", style_role="diagram", x = 110, y = 85, font_size=22),
            RectSlot(id="slot.cloud2.core", prompt="", x = 225, y = 55, width=120.0, height=50.0, rx=20.0, ry=20.0),
            TextSlot(id="slot.cloud2.text", prompt="", text="20 × 70", style_role="diagram", x = 245, y = 85, font_size=22),
            RectSlot(id="slot.cloud3.core", prompt="", x = 355, y = 55, width=120.0, height=50.0, rx=20.0, ry=20.0),
            TextSlot(id="slot.cloud3.text", prompt="", text="40 × 50", style_role="diagram", x = 375, y = 85, font_size=22),
            RectSlot(id="slot.cloud4.core", prompt="", x = 485, y = 55, width=120.0, height=50.0, rx=20.0, ry=20.0),
            TextSlot(id="slot.cloud4.text", prompt="", text="36 × 60", style_role="diagram", x = 505, y = 85, font_size=22),
        ),
        diagrams=(),
        groups=(),
        constraints=(),
