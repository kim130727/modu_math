    ...
    return ProblemTemplate(
        ...
        regions=(
            Region(
                ...
                role="stem",
                flow="absolute",
                slot_ids=("slot.qnum", "slot.stem", "slot.speech.bubble", "slot.speech.tail", "slot.speech.text"),
            ),
            Region(
                id="region.diagram",
                role="diagram",
        ...
        slots=(
            TextSlot(id="slot.checkbox", prompt="", text="□", style_role="question", x=12.0, y=30.0, font_size=18),
            TextSlot(id="slot.qnum", prompt="", text="18.", style_role="question", x=35.0, y=31.0, font_size=22),
            TextSlot(
                id="slot.stem",
                prompt="",
            ...
            *fold_slots,
            ...
            PathSlot(
                ...
                prompt="",
                d="M 828 374 C 812 350, 826 329, 856 307",
                stroke="#00843D",
                stroke_width=2.0,
                fill="none",
            ),
            ...
            TextSlot(id="slot.correct", prompt="", text="(정답)지름", style_role="answer", x=14.0, y=577.0, font_size=18),
            TextSlot(
                id="slot.explain",
                prompt="",
                text="(해설)원을 둘로 똑같이 나누는 선분은 원의 중심을 지나므로 원의 지름입니다.",
