    ...
    return ProblemTemplate(
        ...
        slots=(
            TextSlot(
                id="slot.q1",
                prompt="",
                text = '원의 지름을 나타내는 선분을 찾아 선택하세요.', style_role="question",
                x = 30, y = 40, font_size = 30),
            CircleSlot(
                id="slot.circle", prompt="", cx = 399, cy = 170, r = 105, fill="none"
            ),
            CircleSlot(
                id="slot.center", prompt="", cx = 400, cy = 170, r = 5, fill="#ff4da6"
            ),
            LineSlot(
                id="slot.line.diameter",
                prompt="",
                x1 = 310, y1 = 225, x2 = 490, y2 = 115),
            LineSlot(
                id="slot.line.vertical",
                prompt="",
                x1 = 490, y1 = 115, x2 = 490, y2 = 220),
            LineSlot(
                id="slot.line.right", prompt="", x1 = 400, y1 = 170, x2 = 400, y2 = 275),
            TextSlot(
                id="slot.lb.g",
                prompt="",
                text = 'ㄱ', style_role="label",
                x = 270, y = 235, font_size = 30),
            TextSlot(
                id="slot.lb.n",
                prompt="",
                text = 'ㄴ', style_role="label",
                x = 400, y = 304, font_size = 30, max_width = 800),
            TextSlot(
                id="slot.lb.d",
                prompt="",
                text = 'ㄷ', style_role="label",
                x = 505, y = 250, font_size = 30),
            TextSlot(
                id="slot.lb.r",
                prompt="",
                text = 'ㄹ', style_role="label",
                x = 495, y = 110, font_size = 30),
            TextSlot(
                id="slot.lb.o",
                prompt="",
                text = 'ㅇ', style_role="label",
                x = 375, y = 160, font_size = 30),
            RectSlot(
                id="slot.choice_box",
                prompt="",
                x = 40, y = 309, width = 740, height = 70, fill="none",
            ),
            TextSlot(
                id="slot.choice.1",
                prompt="",
                text = '1. 선분 ㄱㄹ', style_role="choice",
                x = 80, y = 355, font_size = 30, max_width = 800),
            TextSlot(
                id="slot.choice.2",
                prompt="",
                text = '2. 선분 ㅇㄱ', style_role="choice",
                x = 255, y = 355, font_size = 30, max_width = 800),
            TextSlot(
                id="slot.choice.3",
                prompt="",
                text = '3. 선분 ㅇㄴ', style_role="choice",
                x = 430, y = 355, font_size = 30, max_width = 800),
            TextSlot(
                id="slot.choice.4",
                prompt="",
                text = '4. 선분 ㄷㄹ', style_role="choice",
                x = 595, y = 355, font_size = 30, max_width = 800),
        ),
        diagrams=(),
        groups=(),
        constraints=(),
