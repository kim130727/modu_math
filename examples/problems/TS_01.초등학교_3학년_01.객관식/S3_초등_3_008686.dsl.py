    ...
    return ProblemTemplate(
        ...
        slots=(
            TextSlot(
                id="slot.qnum",
                prompt="",
                text="    다음을 읽고 바르게 설명하였으면 ○표,    ",
                style_role="question",
                x=10,
                y=50,
                font_size=30,
            ),
            CircleSlot(id="slot.diagram.circle", prompt="", cx=359, cy=249, r=90, fill="none"),
            CircleSlot(id="slot.pt.center", prompt="", cx=360, cy=250, r=5, fill="#ff2aa8"),
            LineSlot(id="slot.diagram.diameter", prompt="", x1=270, y1=250, x2=450, y2=250),
            TextSlot(
            ...
            CircleSlot(id="slot.diagram.center_mark", prompt="", cx=365, cy=230, r=5, fill="none"),
            CircleSlot(id="slot.diagram.pink_dot", prompt="", cx=360, cy=245, r=0, fill="none"),
            TextSlot(
                id="slot.statement",
                prompt="",
