...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        slots=(
            ...
            CircleSlot(
                id="slot.opt1.num", prompt="", cx=52.0, cy=98.0, r=8.0, fill="#EAF4FF"
            ),
            TextSlot(
                id="slot.opt1.text",
                prompt="",
            ...
            CircleSlot(
                id="slot.opt2.num", prompt="", cx=313.0, cy=98.0, r=8.0, fill="#EAF4FF"
            ),
            TextSlot(
                id="slot.opt2.text",
                prompt="",
            ...
            CircleSlot(
                id="slot.opt3.num", prompt="", cx=612.0, cy=98.0, r=8.0, fill="#EAF4FF"
            ),
            TextSlot(
                id="slot.opt3.text",
                prompt="",
            ...
            CircleSlot(
                id="slot.opt4.num", prompt="", cx=52.0, cy=146.0, r=8.0, fill="#EAF4FF"
            ),
            TextSlot(
                id="slot.opt4.text",
                prompt="",
            ...
            CircleSlot(
                id="slot.opt5.num", prompt="", cx=313.0, cy=146.0, r=8.0, fill="#EAF4FF"
            ),
            TextSlot(
                id="slot.opt5.text",
                prompt="",
            ...
            LineSlot(id="slot.arrow", prompt="", x1=36.0, y1=388.0, x2=58.0, y2=388.0),
        ),
        diagrams=(),
        groups=(),
        constraints=(),
