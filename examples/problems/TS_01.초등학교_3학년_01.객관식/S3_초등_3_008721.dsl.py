...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        slots=(
            ...
            CircleSlot(id="slot.diagram.circle", prompt="", cx=450, cy=231, r=135, fill="none"),
            CircleSlot(id="slot.diagram.center", prompt="", cx=450, cy=231, r=5, fill="#ff2a8a"),
            LineSlot(id="slot.diagram.line1", prompt="", x1=480, y1=100, x2=490, y2=360),
            LineSlot(id="slot.diagram.line2", prompt="", x1=445, y1=95, x2=455, y2=365),
            ...
            TextSlot(
                id="slot.diagram.label.ya.copy3",
                prompt="",
                text="ㅇ",
                x=420,
                y=255,
