...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        regions=(
            ...
            Region(
                ...
                slot_ids=("slot.circle.outer",
                    ...
                    "slot.lb.na",
                    "slot.lb.da",
                    "slot.pt.center",'slot.lb.ga.copy1'),
            ),
            Region(
                id="region.question",
                role="stem",
        ...
        slots=(TextSlot(
                id="slot.header.text",
                prompt="",
                text = '알맞은 말을 선택해 보시오.', style_role="question",
                x=34.0,
                y=32.0,
                font_size=28,
            ),
            CircleSlot(
                ...
                prompt="",
                cx = 376, cy = 180, r = 125, fill="none",
            ),
            LineSlot(
                id="slot.line.g1", prompt="", x1 = 375, y1 = 180, x2 = 265, y2 = 125),
            LineSlot(
                id="slot.line.g2", prompt="", x1 = 375, y1 = 180, x2 = 445, y2 = 285),
            LineSlot(
                id="slot.line.g3", prompt="", x1 = 375, y1 = 180, x2 = 465, y2 = 95),
            CircleSlot(
                id="slot.pt.center",
                prompt="",
                cx = 375, cy = 180, r = 5, fill="#d4006a",
            ),
            TextSlot(
                id="slot.lb.ga",
                prompt="",
                text = 'ㄱ', style_role="label",
                x = 235, y = 120, font_size = 20),
            TextSlot(
                id="slot.lb.na",
                prompt="",
                text = 'ㄴ', style_role="label",
                x = 450, y = 300, font_size = 20),
            TextSlot(
                id="slot.lb.da",
                prompt="",
                text = 'ㄷ', style_role="label",
                x = 475, y = 95, font_size = 20),
            TextSlot(
                id="slot.q1",
                prompt="",
                text = '모두 원의 (지름, 반지름, 중심)입니다.    ', style_role="question",
                x = 55, y = 395, font_size = 30),TextSlot(id = 'slot.lb.ga.copy1', prompt = '', text = 'ㅇ', x = 350, y = 205, font_size = 20, fill = '#111111'), TextSlot(id = 'slot.q1.copy2', prompt = '', text = '        선분 ㄱㅇ, 선분 ㄴㅇ, 선분 ㄷㅇ은', x = 55, y = 355, font_size = 30, fill = '#111111')),
        diagrams=(),
        groups=(),
        constraints=(),
        tags=("원의용어", "반지름", "초등수학"),
