...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        slots=(
            RectSlot(id="slot.chk", prompt="", x=6.0, y=14.0, width=13.0, height=13.0),
            TextSlot(
                id="slot.no",
                prompt="",
                text="76.",
            ...
            RectSlot(
                id="slot.box1", prompt="", x=248.0, y=44.0, width=190.0, height=78.0
            ),
            RectSlot(
                id="slot.box2", prompt="", x=520.0, y=44.0, width=190.0, height=78.0
            ),
            TextSlot(
                id="slot.box1.text",
                prompt="",
