    ...
    return ProblemTemplate(
        ...
        slots=(
            ...
            RectSlot(
                id="slot.paper.left",
                prompt="",
                x = 275, y = 100, width = 120, height = 60, fill="#FDE8EF",
                stroke="#FF9AB2",
                stroke_width=2.0,
            ),
            LineSlot(
                id="slot.arrow",
                prompt="",
                x1 = 475, y1 = 125, x2 = 515, y2 = 125, stroke="#9AA0A6",
                stroke_width=3.0,
            ),
            CircleSlot(
                id="slot.paper.right",
            ...
            TextSlot(
                id="slot.c4",
                prompt="",
                text = 'TODO: 하단 일부 잘린 문장과 선택지 배치는 원문 이미지에서 추가 확인 필요', style_role="note",
                x = 240, y = 330, font_size = 20, max_width = 810),
        ),
        diagrams=(),
        groups=(),
        constraints=(),
