    ...
    return ProblemTemplate(
        ...
        regions=(
            Region(
                ...
                role="stem",
                flow="absolute",
                slot_ids=("slot.icon", "slot.qnum", "slot.stem"),
            ),
            Region(
        ...
        slots=(
            ...
            TextSlot(
                id="slot.stem",
                prompt="",
                text="나머지가 가장 큰 것을 찾는 기호를 선택하세요.",
                style_role="question",
                x=84.0,
                y=22.0,
                font_size=28,
            ...
            RectSlot(
                id="slot.box", prompt="", x=233.0, y=50.0, width=510.0, height=75.0
            ),
            TextSlot(
                id="slot.choice_mark.a",
                prompt="",
                text="◯",
                style_role="label",
                x=262.0,
