...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        slots=(
            ...
            TextSlot(id="slot.c1", prompt="", text = '5 × 6', style_role="choice", x = 120, y = 385, font_size = 40),
            TextSlot(id="slot.c2", prompt="", text = '50 × 6', style_role="choice", x = 295, y = 385, font_size = 40),
        ),
        diagrams=(),
        groups=(),
        constraints=(),
