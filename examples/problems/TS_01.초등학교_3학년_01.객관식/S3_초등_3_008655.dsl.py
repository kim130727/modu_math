        ...
        regions=(
            Region(
                ...
                slot_ids=("slot.q1",
                    ...
                    "slot.diagram.lb.n",
                    "slot.diagram.lb.d",
                    "slot.choice",'slot.q1.copy1'),
            ),
        ),
        slots=(TextSlot(
                id="slot.q1",
                prompt="",
                text = '선분 ㅇㄱ, 선분 ㅇㄴ, 선분 ㅇㄷ은 모두 원의 반지름입니다.  ', style_role="question",
                x=18.0,
                y=34.0,
                font_size=28,
            ),
            CircleSlot(
                ...
                prompt="",
                cx = 390, cy = 240, r = 110, fill="none",
            ),
            LineSlot(
                id="slot.diagram.r1", prompt="", x1 = 390, y1 = 240, x2 = 305, y2 = 310),
            LineSlot(
                id="slot.diagram.r2", prompt="", x1 = 390, y1 = 240, x2 = 465, y2 = 320),
            LineSlot(
                id="slot.diagram.r3", prompt="", x1 = 390, y1 = 240, x2 = 500, y2 = 220),
            CircleSlot(
                id="slot.diagram.center",
                prompt="",
                cx = 390, cy = 240, r = 5, fill="#d81b60",
            ),
            TextSlot(
                id="slot.diagram.lb.g",
                prompt="",
                text = 'ㄱ', style_role="label",
                x = 280, y = 335, font_size = 30),
            TextSlot(
                id="slot.diagram.lb.n",
                prompt="",
                text = 'ㄴ', style_role="label",
                x = 470, y = 335, font_size = 30),
            TextSlot(
                id="slot.diagram.lb.d",
                prompt="",
                text = 'ㄷ', style_role="label",
                x = 505, y = 215, font_size = 30),
            TextSlot(
                id="slot.choice",
                prompt="",
                text = '한 원에서 원의 반지름은 모두 ( 같습니다, 다릅니다 ).', style_role="question",
                x = 30, y = 405, font_size = 30),TextSlot(id = 'slot.q1.copy1', prompt = '', text = '각 선분의 길이를 재어 알맞은 말을 선택하세요.  ', x = 20, y = 80, font_size = 30, max_width = 832, fill = '#111111')),
        diagrams=(),
        groups=(),
        constraints=(),
        tags=(),
