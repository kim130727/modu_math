...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        slots=(
            ...
            RectSlot(id="slot.bottle.body", prompt="", x=343.0, y=107.0, width=32.0, height=105.0),
            RectSlot(id="slot.bottle.neck", prompt="", x=353.0, y=93.0, width=12.0, height=18.0),
            RectSlot(id="slot.bottle.cap", prompt="", x=352.0, y=84.0, width=14.0, height=10.0),
            TextSlot(
            ...
            PathSlot(
                id="slot.leftarrow",
                prompt="",
                d="M 394.0 99.0 C 409.0 86.0, 428.0 85.0, 441.0 98.0",
            ),
            PathSlot(
                id="slot.rightarrow",
                prompt="",
                d="M 672.0 99.0 C 658.0 86.0, 639.0 85.0, 626.0 98.0",
            ),
            RectSlot(id="slot.cup1.body", prompt="", x=432.0, y=110.0, width=36.0, height=97.0),
            RectSlot(id="slot.cup1.water", prompt="", x=435.0, y=115.0, width=30.0, height=92.0),
            RectSlot(id="slot.cup2.body", prompt="", x=488.0, y=110.0, width=36.0, height=97.0),
            RectSlot(id="slot.cup2.water", prompt="", x=491.0, y=149.0, width=30.0, height=58.0),
            RectSlot(id="slot.glass.body", prompt="", x=669.0, y=112.0, width=38.0, height=80.0),
            LineSlot(id="slot.glass.stem", prompt="", x1=688.0, y1=192.0, x2=688.0, y2=215.0),
            RectSlot(id="slot.glass.base", prompt="", x=676.0, y=214.0, width=24.0, height=6.0),
            TextSlot(
