...
SOLVABLE = {'schema': 'modu.solvable.v1.2',
 ...
 'answer': {'blanks': [{'id': 'slot.answer', 'type': 'number', 'value': 4.2, 'unit': 'cm'}],
            ...
            'target': {'type': 'perimeter_difference', 'description': '圆的周长减去正六边形周长所得的值'},
            'value': 4.2,
            'unit': 'cm'},
 'understanding': {'summary': 'Find 圆与正六边形的周长之差 using the given information.',
                   ...
                   'relation': {'type': 'compare_circle_and_inscribed_hexagon_perimeters',
                                'statement': '将圆的直径30 cm除以2，求出半径15 cm。',
                                'symbolic': '30 ÷ 2',
                   ...
                   'diagnostic_questions': [{'id': 'understand.target',
                                             ...
                                             'choices': ['diameter', 'pi', '圆与正六边形的周长之差'],
                                             'answer_index': 2}]}}
