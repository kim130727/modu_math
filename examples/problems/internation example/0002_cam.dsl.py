...
SOLVABLE = {'schema': 'modu.solvable.v1.2',
 ...
 'plan': ['ចែកអង្កត់ផ្ចិតរង្វង់ 30cm នឹង 2 ដើម្បីរកកាំ 15cm។',
 ...
 'answer': {'blanks': [{'id': 'slot.answer', 'type': 'number', 'value': 4.2, 'unit': 'cm'}],
            ...
            'value': 4.2,
            'unit': 'cm'},
 'understanding': {'summary': 'Find ផលខុសគ្នារវាងបរិមាត្ររង្វង់ និងឆកោនទៀងទាត់ using the given '
                              'information.',
                   ...
                   'unknowns': [{'ref': 'answer.target',
                                 'label': 'ផលខុសគ្នារវាងបរិមាត្ររង្វង់ និងឆកោនទៀងទាត់',
                                 'unit': 'cm',
                                 'source': 'unknown'}],
                   'relation': {'type': 'compare_circle_and_inscribed_hexagon_perimeters',
                                'statement': 'ចែកអង្កត់ផ្ចិតរង្វង់ 30cm នឹង 2 ដើម្បីរកកាំ 15cm។',
                                'symbolic': '30 ÷ 2',
