...
def build_problem_template() -> ProblemTemplate:
    ...
    slots = (
        TextSlot(
            id="slot.q1",
            prompt="",
            text="ជ្រើសកន្សោមគុណដែលផ្នែកដាក់ពណ៌តំណាង។",
            style_role="question",
            x=58.0,
            y=55.0,
            font_size=28,
    ...
    return ProblemTemplate(
        id="S3_elem_3_008540",
        title="ជ្រើសកន្សោមគុណដែលផ្នែកដាក់ពណ៌តំណាង។",
        canvas=canvas,
        regions=regions,
        slots=slots,
        diagrams=diagrams,
...
SOLVABLE = {
    ...
    "plan": [
        "ពិនិត្យតម្លៃខ្ទង់ដែលផ្នែកដាក់ពណ៌តំណាង រួមជាមួយការពន្យល់។",
        "រកកន្សោមដូចគ្នាក្នុងចំណោមជម្រើស។",
    ],
    "steps": [
