...
def build_problem_template() -> ProblemTemplate:
    ...
    slots = (
        TextSlot(
            id="slot.q1",
            prompt="",
            text="㉮と㉯の水筒を水でいっぱいにし、同じ形と大きさの容器に移して",
            style_role="question",
            x=16,
            y=52,
            font_size=28,
        ...
        TextSlot(
            id="slot.q2",
            prompt="",
            text="移しました。図のように水を入れたときの㉮と㉯の水筒の容量を比べ",
            style_role="question",
            x=16,
            y=86,
            font_size=28,
        ...
        TextSlot(
            id="slot.choice.1",
            prompt="",
            text="(1) 移し替えた水の高さがより高いのは（㉮の水筒、㉯の水筒）です。",
            style_role="question",
            x=36,
            y=402,
            font_size=28,
...
SEMANTIC_OVERRIDE = {
    ...
    "domain": {
        "objects": [
            {"id": "obj.bottle.ga", "type": "물병", "label": "㉮の水筒"},
            {"id": "obj.bottle.na", "type": "물병", "label": "㉯の水筒"},
            {
