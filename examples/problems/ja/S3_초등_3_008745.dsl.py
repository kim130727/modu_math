...
def build_problem_template() -> ProblemTemplate:
    ...
    slots = (
        TextBoxSlot(
            id="slot.question",
            prompt="",
            text="アとイの水筒を水でいっぱいにした後、形と大きさが同じ容器に移しました。図に示された水の高さから、アとイの水筒の容量を比べます。正しい言葉を選んでください。",
            style_role="question",
            x=66.684,
            y=17.307,
            width=825.55,
        ...
        TextSlot(
            id="slot.choice.1",
            prompt="",
            text="(1) 移し替えた水の高さがより高いのは（アの水筒、イの水筒）です。",
            style_role="question",
            x=36,
            y=402,
            font_size=28,
        ...
        TextSlot(
            id="slot.choice.2",
            prompt="",
            text="(2) 容量がより大きいのは（アの水筒、イの水筒）です。",
            style_role="question",
            x=36,
            y=448,
            font_size=28,
...
SEMANTIC_OVERRIDE = {
    ...
    "metadata": {
        "language": "ko",
        "question": "アとイの水筒の容量を比べる問題",
        "instruction": "正しい言葉を選んでください。",
    },
    "domain": {
        "objects": [
            {"id": "obj.bottle.ga", "type": "물병", "label": "アの水筒"},
            {"id": "obj.bottle.na", "type": "물병", "label": "イの水筒"},
            {
