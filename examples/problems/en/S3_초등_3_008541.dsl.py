...
def build_problem_template() -> ProblemTemplate:
    ...
    slots = (
        TextSlot(
            id="slot.q1",
            prompt="",
            text="Choose the option that lists the results from greatest to least.",
            style_role="question",
            x=105.018,
            y=76,
            font_size=28,
    ...
    return ProblemTemplate(
        id="S3_초등_3_008541",
        title="Choose the option that lists the results from greatest to least",
        canvas=canvas,
        regions=regions,
        slots=slots,
        diagrams=diagrams,
...
SOLVABLE = {
    ...
    "plan": [
        "Calculate each product, then compare them from greatest to least.",
        "Find the option number that matches the comparison order.",
    ],
    "steps": [
