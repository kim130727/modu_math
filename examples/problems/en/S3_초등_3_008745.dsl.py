...
def build_problem_template() -> ProblemTemplate:
    ...
    slots = (
        ...
        TextSlot(
            id="slot.choice.1",
            prompt="",
            text="(1) The bottle whose poured water level is higher is (Bottle A, Bottle B).",
            style_role="question",
            x=36,
            y=402,
            font_size=28,
        ...
        TextSlot(
            id="slot.choice.2",
            prompt="",
            text="(2) The bottle with the greater capacity is (Bottle A, Bottle B).",
            style_role="question",
            x=36,
            y=448,
            font_size=28,
...
SEMANTIC_OVERRIDE = {
    ...
    "domain": {
        "objects": [
            {"id": "obj.bottle.ga", "type": "물병", "label": "Bottle A"},
            {"id": "obj.bottle.na", "type": "물병", "label": "Bottle B"},
            {
...
SOLVABLE = {
    ...
    "plan": [
        "Compare the heights of the water poured into containers of the same shape and size.",
        "Conclude that the side with the higher water level has the greater capacity.",
    ],
    "steps": [
