...
def build_problem_template() -> ProblemTemplate:
    ...
    slots = (
        TextSlot(
            id="slot.q1",
            prompt="",
            text="Choose the multiplication expression represented by the shaded part.",
            style_role="question",
            x=58.0,
            y=55.0,
            font_size=28,
    ...
    return ProblemTemplate(
        id="S3_elem_3_008540",
        title="Choose the multiplication expression represented by the shaded part.",
        canvas=canvas,
        regions=regions,
        slots=slots,
        diagrams=diagrams,
...
SEMANTIC_OVERRIDE = {
    ...
    "answer": {
        ...
        "target": {"type": "choice_value", "description": "색칠한 부분 240에 해당하는 보기 번호"},
        "value": "(3) 60 × 4",
        "unit": "",
    },
}
...
SOLVABLE = {
    ...
    "plan": [
        "Check the place value represented by the shaded part together with the explanation.",
        "Find the identical expression among the choices.",
    ],
    "steps": [
    ...
    "understanding": {
        ...
        "facts": [
            {
                "ref": "obj.multiple",
                "label": "whole multiplication",
                "value": "869 x 4",
                "unit": "",
                "source": "explicit",
            },
            {
                "ref": "obj.highlighted_value",
                "label": "highlighted partial product",
                "value": 240,
                "unit": "",
                "source": "explicit",
            },
            {
                "ref": "obj.choice_set",
                "label": "choices",
                "value": ["6 x 4", "69 x 4", "60 x 4", "600 x 4"],
                "unit": "",
                "source": "explicit",
            },
        ],
        ...
        "relation": {
            ...
            "statement": "The digit 6 in 869 has value 60, so the highlighted "
            "partial product 240 is 60 x 4.",
            "symbolic": "60 x 4 = 240",
