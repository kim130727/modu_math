        ...
        regions=(
            ...
            Region(
                ...
                slot_ids=("slot.start_oval",
                    ...
                    "slot.arrow_2_curve",
                    "slot.arrow_2_head",
                    "slot.answer_2_oval",'konva_1784508924476_arrow_10107', 'konva_1784508924476_paste_46500_0', 'konva_1784508924476_paste_46916_0', 'konva_1784508924476_paste_96959_0'),
            ),
        ),
        slots=(TextBoxSlot(
                id="slot.instruction",
                ...
                x = 16.254, y = 7.545, width = 222.057, height = 26, font_size = 15, line_height = 1.15, fill = '#111111', align = 'left'),
            PathSlot(
                id="slot.start_oval",
            ...
            BlankSlot(
                ...
                answer_key="1131",
                placeholder="",
            ),PathSlot(id = 'konva_1784508924476_arrow_10107', prompt = '', d = 'M 59.141 80.62 L 78.893 61.331 M 78.893 61.331 L 75.027 71.963 M 78.893 61.331 L 68.169 64.94', fill = 'none', stroke = '#111827', stroke_width = 1.2), PathSlot(id = 'konva_1784508924476_paste_46500_0', prompt = '', d = 'M 169.752 78.521 L 189.504 59.232 M 189.504 59.232 L 185.638 69.864 M 189.504 59.232 L 178.78 62.841', fill = 'none', stroke = '#111827', stroke_width = 1.2), PathSlot(id = 'konva_1784508924476_paste_46916_0', prompt = '', d = 'M 293.37 76.136 L 313.122 56.847 M 313.122 56.847 L 309.256 67.479 M 313.122 56.847 L 302.398 60.456', fill = 'none', stroke = '#111827', stroke_width = 1.2), PathSlot(id = 'konva_1784508924476_paste_96959_0', prompt = '', d = 'M 183.891 80.136 L 203.643 60.847 M 203.643 60.847 L 199.777 71.479 M 203.643 60.847 L 192.919 64.456', fill = 'none', stroke = '#111827', stroke_width = 1.2)),
        diagrams=(),
        groups=(
            Group(
