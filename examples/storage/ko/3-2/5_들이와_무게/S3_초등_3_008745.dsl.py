    ...
    return ProblemTemplate(
        ...
        slots=(
            ...
            TextSlot(
                id="slot.choice.1",
                prompt="",
                text="(1) 옮겨 담은 물의 높이가 더 높은 것은 ( ㉮ 물병, ㉯ 물병)입니다.",
                style_role="question",
                x=36,
                y=402,
                font_size=28,
...
SEMANTIC_OVERRIDE = {
    ...
    "answer": {
        "blanks": [],
        "choices": ["가 물병", "나 물병"],
        "choice_groups": [{"label": "(1)번 문제", "choices": ["가 물병", "나 물병"]}, {"label": "(2)번 문제", "choices": ["가 물병", "나 물병"]}],
        "answer_key": ["나 물병", "나 물병"],
        "target": {"type": "multiple_choice_group", "description": "옮겨 담은 물의 높이가 더 높은 것과 들이가 더 많은 것"},
        "value": "나 물병, 나 물병",
        "unit": "",
    },
}
