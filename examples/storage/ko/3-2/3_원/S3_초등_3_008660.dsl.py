...
SEMANTIC_OVERRIDE = {
    ...
    "answer": {
        ...
        "target": {
            ...
            "description": "원의 반지름을 나타내는 선분 모두 선택",
        },
        "value": "1. 선분 ㅇㄱ, 2. 선분 ㅇㄴ",
        "unit": "",
    },
}
...
SOLVABLE = {
    ...
    "given": [
        ...
        {"ref": "obj.radius_candidate_1", "value": {"label": "선분 ㅇㄱ"}},
        {"ref": "obj.radius_candidate_2", "value": {"label": "선분 ㅇㄴ"}},
    ],
    "target": {"ref": "answer.target", "type": "multiple_choice_set"},
    "method": "identify_radius_by_center_and_point",
    "plan": [
        "원의 중심 ㅇ에서 원 위의 점으로 이어진 선분을 찾는다.",
        "반지름에 해당하는 선분을 모두 고른다.",
    ],
    "steps": [
        {
            "id": "step.1",
        ...
        {"id": "step.2", "expr": "반지름에 해당하는 보기 선택", "value": "1. 선분 ㅇㄱ, 2. 선분 ㅇㄴ"},
    ],
    "checks": [
        {
            "id": "check.1",
