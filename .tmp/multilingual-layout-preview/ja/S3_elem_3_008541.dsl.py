...
SEMANTIC_OVERRIDE = {
    ...
    "domain": {
        "objects": [
            {"id": "obj.a", "type": "expression", "label": "ア", "operation": "397 × 6"},
            {"id": "obj.b", "type": "expression", "label": "イ", "operation": "549 × 4"},
            {"id": "obj.c", "type": "expression", "label": "ウ", "operation": "456 × 5"},
            {"id": "obj.option2", "type": "choice", "label": "②", "sequence": ["ア", "ウ", "イ"]},
        ],
        "relations": [
