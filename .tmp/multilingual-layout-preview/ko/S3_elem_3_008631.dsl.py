...
def build_problem_template() -> ProblemTemplate:
    diagram_slots = (
        ...
        *_partition_box("slot.figure.group1", x=135, y=230),
        *_partition_box("slot.figure.group2", x=275, y=230),
        *_partition_box("slot.figure.group3", x=420, y=230),
...
SEMANTIC_OVERRIDE = {
    ...
    "domain": {
        ...
        "relations": [
            {"id": "rel.division", "type": "division", "from_id": "obj.dividend", "to_id": "obj.divisor", "dividend": 69, "divisor": 3, "quotient": 23},
