...
def build_problem_template() -> ProblemTemplate:
    ...
    slots = (
        TextSlot(
            id="slot.q_text",
            prompt="",
            text="Which line segment is the longest?",
            style_role="question",
            x=40,
            y=35,
            font_size=30,
    ...
    return ProblemTemplate(
        id="S3_elem_3_008661",
        title="Which line segment is the longest?",
        canvas=canvas,
        regions=regions,
        slots=slots,
        diagrams=diagrams,
...
SEMANTIC_OVERRIDE = {
    ...
    "domain": {
        "objects": [
            ...
            {"id": "obj.segment.ss", "type": "segment", "label": "GG"},
    ...
    "answer": {
        "blanks": [],
        "choices": ["1. 선분 AB", "2. 선분 CD", "3. 선분 EF", "4. 선분 GI"],
        "answer_key": ["2. 선분 CD"],
...
SOLVABLE = {
    ...
    "given": [
        {"ref": "obj.segment.gn", "value": {"label": "선분 AB"}},
        {"ref": "obj.segment.dr", "value": {"label": "선분 CD"}},
        {"ref": "obj.segment.mb", "value": {"label": "선분 EF"}},
        {"ref": "obj.segment.ss", "value": {"label": "선분 GI"}},
    ],
    "target": {"ref": "answer.target", "type": "choice_selection"},
    "method": "visual_comparison",
    "plan": [
        "Compare the four line segments inside the circle.",
        "Find the line segment that passes through the center.",
        "Choose the number corresponding to that line segment.",
    ],
    "steps": [
        {"id": "step.1", "expr": "중심을 지나는 선분 확인", "value": "선분 CD"},
        {"id": "step.2", "expr": "보기와 대응", "value": "2. 선분 CD"},
    ],
    "checks": [
        {
            "id": "check.1",
