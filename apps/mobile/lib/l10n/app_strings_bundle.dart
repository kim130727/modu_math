...
const Map<String, Map<String, String>> bundledTranslations = {
  'ko': {
    ...
    'problem.defaultSubTopic': '기본 개념 탐험',
    'problem.missionCode': '미션 코드: {code}',
    'problem.fairyWhisper': '자릿수 요정의 속삭임',
    'problem.tutorPlaceValueQuote':
        '"6은 단순한 6이 아니에요! 십의 자리에 살고 있으니 60을 의미한답니다."',
    ...
    'diagnostic.unauthenticatedDescription':
  ...
  'uk': {
    ...
    'problem.defaultSubTopic': 'Дослідження базових понять',
    'problem.missionCode': 'Код місії: {code}',
    'problem.fairyWhisper': 'Шепіт феї розрядів',
    'problem.tutorPlaceValueQuote':
        '"6 — це не просто 6! Вона стоїть у розряді десятків, тому означає 60."',
    'problem.tutorDefaultQuote':
        '"Шукайте ключові підказки! В умовах задачі приховано ключ до відповіді."',
    'explorer.multiplicationTitle': '{expr} Дослідження стовпчика',
    'explorer.multiplicationSubtitle':
        'Подивіться, як утворюється кожен рядок при обчисленні у стовпчик.',
    'explorer.standardTitle': '{topic} Дослідник концепцій',
    'explorer.standardSubtitle':
        'Уважно розгляньте малюнок та умови і розв\'яжіть задачу.',
    ...
    'explorer.multiplicationHintNote':
        'Виберіть у варіантах праворуч початковий вираз, який утворює рожеве число 240!',
    'explorer.standardHintNote':
        'Знайдіть у варіантах праворуч правильну відповідь до умов задачі!',
    ...
    'diagnostic.unauthenticatedTitle':
        'Увійдіть, щоб отримати індивідуальну діагностику з математики!',
    'diagnostic.unauthenticatedDescription':
        'З кожною розв’язаною задачею автоматично аналізується рівень засвоєння понять і вмінь,\nа для усунення прогалин рекомендуються персоналізовані вправи.',
