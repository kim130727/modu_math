"""문제 0004 DSL 빌드 파일. 수 모형 덧셈 문제(137+286) 레이아웃을 구성합니다."""
...
# 레이아웃 상수
def build() -> Problem:
    p = Problem(width=CANVAS_W, height=CANVAS_H, problem_id="0004", problem_type="base_ten_block_addition")
