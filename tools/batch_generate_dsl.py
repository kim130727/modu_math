...
try:
    ...
    from tools.llm_client import load_dotenv_if_available, resolve_provider
    ...
    from llm_client import load_dotenv_if_available, resolve_provider
...
def main(argv: list[str] | None = None) -> int:
    ...
    resolved_model = (
        ...
        else (args.model or os.getenv("GOOGLE_MODEL") or "gemini-2.5-flash")
    )
